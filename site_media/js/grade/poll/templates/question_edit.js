...
"	<ul class=\"optionset\">" +
"		<li class=\"isScale\" style=\"display: none;\">" +
...
"		</li>" +
"		<li class=\"choiceLimit\" style=\"display: none;\">" +
...
"		</li>" +
"		<li class=\"hasOther\" style=\"display: none;\">" +
...
"		</li>" +
"		<li class=\"leading\" style=\"display: none;\">" +
"			<input type=\"checkbox\" id=\"poll[question][${id}][leading]\" name=\"poll[question][${id}][leading]\">" +
"			<label for=\"poll[question][${id}][leading]\">Pytanie wiodące</label>" +
"		</li>" +
"	</ul>" +
