...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employee.homepage'
        db.add_column('users_employee', 'homepage', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Employee.homepage'
        db.delete_column('users_employee', 'homepage')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'homepage': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'null': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
