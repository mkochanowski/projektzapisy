...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employee.receive_mass_mail_grade'
        db.add_column('users_employee', 'receive_mass_mail_grade', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Student.receive_mass_mail_grade'
        db.add_column('users_student', 'receive_mass_mail_grade', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Employee.receive_mass_mail_grade'
        db.delete_column('users_employee', 'receive_mass_mail_grade')

        # Deleting field 'Student.receive_mass_mail_grade'
        db.delete_column('users_student', 'receive_mass_mail_grade')
