...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudiaZamawiane.points'
        db.alter_column('users_studiazamawiane', 'points', self.gf('django.db.models.fields.FloatField')(null=True, blank=True))

        # Changing field 'Employee.consultations'
        db.alter_column('users_employee', 'consultations', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'Employee.room'
        db.alter_column('users_employee', 'room', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))

        # Changing field 'Employee.homepage'
        db.alter_column('users_employee', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'StudiaZamawiane.points'
        db.alter_column('users_studiazamawiane', 'points', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Employee.consultations'
        db.alter_column('users_employee', 'consultations', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Employee.room'
        db.alter_column('users_employee', 'room', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Employee.homepage'
        db.alter_column('users_employee', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 19, 19, 42, 26, 376405)'}),
