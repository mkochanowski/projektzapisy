...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudiaZamawianeMaileOpiekunow'
        db.create_table('users_studiazamawianemaileopiekunow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('users', ['StudiaZamawianeMaileOpiekunow'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'StudiaZamawianeMaileOpiekunow'
        db.delete_table('users_studiazamawianemaileopiekunow')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 30, 18, 20, 28, 53961)'}),
