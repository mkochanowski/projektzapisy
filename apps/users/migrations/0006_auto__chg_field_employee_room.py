...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_employee', 'room', self.gf('django.db.models.fields.CharField')(max_length=6))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 30, 13, 17, 38, 661736)'}),
            ...
            'room': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '6'}),
