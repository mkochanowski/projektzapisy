...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for user in orm['auth.User'].objects.all():
            ...
            try:
                eu = orm.ExtendedUser.objects.get(id=user.id, username=user.username)

                profile.is_student   = eu.is_student
                profile.is_employee  = eu.is_employee
                profile.is_zamawiany = eu.is_zamawiany
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 7, 1, 47, 42, 344085)'}),
