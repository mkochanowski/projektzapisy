...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_student', 'program', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Program'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('users_student', 'program_id')
