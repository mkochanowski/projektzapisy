...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_employee', 'homepage', self.gf('django.db.models.fields.SlugField')(max_length=255))
    
    
    def backwards(self, orm):
        
        # Changing field 'Employee.homepage'
        db.alter_column('users_employee', 'homepage', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))
