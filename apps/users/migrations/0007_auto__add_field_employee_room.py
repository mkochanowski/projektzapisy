...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employee.room'
        db.add_column('users_employee', 'room', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Employee.room'
        db.delete_column('users_employee', 'room')
