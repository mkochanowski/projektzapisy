...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.semestr'
        db.add_column('users_student', 'semestr', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('users_type', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=45, unique=True)),
        ))
        ...
        # Deleting field 'Student.semestr'
        db.delete_column('users_student', 'semestr')
