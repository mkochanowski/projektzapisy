...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vote_systemstate', 'correction_beg', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 1, 1)), keep_default=False)

        # Adding field 'SystemState.correction_end'
        db.add_column('vote_systemstate', 'correction_end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2011, 12, 31)), keep_default=False)
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 11, 3, 54, 386283)'}),
        ...
        'vote.systemstate': {
            ...
            'correction_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 1, 1)'}),
            'correction_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 31)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
