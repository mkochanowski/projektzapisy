...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SystemState.summer_correction_end'
        db.add_column('vote_systemstate', 'summer_correction_end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 7, 31)), keep_default=False)

        # Adding field 'SystemState.summer_correction_beg'
        db.add_column('vote_systemstate', 'summer_correction_beg', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 1, 1)), keep_default=False)

        # Adding field 'SystemState.winter_correction_end'
        db.add_column('vote_systemstate', 'winter_correction_end', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 7, 31)), keep_default=False)

        # Adding field 'SystemState.winter_correction_beg'
        db.add_column('vote_systemstate', 'winter_correction_beg', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 1, 1)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SystemState.summer_correction_end'
        db.delete_column('vote_systemstate', 'summer_correction_end')

        # Deleting field 'SystemState.summer_correction_beg'
        db.delete_column('vote_systemstate', 'summer_correction_beg')

        # Deleting field 'SystemState.winter_correction_end'
        db.delete_column('vote_systemstate', 'winter_correction_end')

        # Deleting field 'SystemState.winter_correction_beg'
        db.delete_column('vote_systemstate', 'winter_correction_beg')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 11, 43, 23, 144193)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 11, 43, 23, 144093)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 11, 43, 22, 909995)'}),
