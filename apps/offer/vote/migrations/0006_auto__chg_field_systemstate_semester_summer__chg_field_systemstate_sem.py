...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SystemState.semester_summer'
        db.alter_column('vote_systemstate', 'semester_summer_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['courses.Semester']))

        # Changing field 'SystemState.semester_winter'
        db.alter_column('vote_systemstate', 'semester_winter_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['courses.Semester']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SystemState.semester_summer'
        db.alter_column('vote_systemstate', 'semester_summer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Semester']))

        # Changing field 'SystemState.semester_winter'
        db.alter_column('vote_systemstate', 'semester_winter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Semester']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 11, 11, 35, 437348)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 11, 11, 35, 437235)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 11, 11, 35, 314153)'}),
        ...
        'vote.systemstate': {
            ...
            'vote_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 7, 31)'}),
