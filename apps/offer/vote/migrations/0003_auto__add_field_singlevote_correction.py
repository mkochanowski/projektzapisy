...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SingleVote.correction'
        db.add_column('vote_singlevote', 'correction', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SingleVote.correction'
        db.delete_column('vote_singlevote', 'correction')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 14, 16, 46, 285251)'}),
        ...
        'vote.systemstate': {
            ...
            'correction_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 31)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'vote_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 7, 31)'}),
