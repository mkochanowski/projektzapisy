...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SystemState.semester_summer'
        db.add_column('vote_systemstate', 'semester_summer', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='summer_votes', to=orm['courses.Semester']), keep_default=False)

        # Adding field 'SystemState.semester_winter'
        db.add_column('vote_systemstate', 'semester_winter', self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='winter_votes', to=orm['courses.Semester']), keep_default=False)

        # Adding field 'SingleVote.entity'
        db.add_column('vote_singlevote', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['courses.CourseEntity']), keep_default=False)

        # Adding field 'SingleVote.proposal'
        db.add_column('vote_singlevote', 'proposal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['proposal.Proposal'], null=True, blank=True), keep_default=False)

        # Changing field 'SingleVote.course'
        db.alter_column('vote_singlevote', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'SystemState.semester_summer'
        db.delete_column('vote_systemstate', 'semester_summer_id')

        # Deleting field 'SystemState.semester_winter'
        db.delete_column('vote_systemstate', 'semester_winter_id')

        # Deleting field 'SingleVote.entity'
        db.delete_column('vote_singlevote', 'entity_id')

        # Deleting field 'SingleVote.proposal'
        db.delete_column('vote_singlevote', 'proposal_id')

        # Changing field 'SingleVote.course'
        db.alter_column('vote_singlevote', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['proposal.Proposal']))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 23, 8, 55, 125988)'}),
        ...
        'vote.singlevote': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.CourseEntity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposal': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['proposal.Proposal']", 'null': 'True', 'blank': 'True'}),
        ...
        'vote.systemstate': {
            ...
            'correction_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 1)'}),
            'correction_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 31)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_points': ('django.db.models.fields.IntegerField', [], {'default': '30'}),
            'max_vote': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
            'semester_summer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'summer_votes'", 'to': "orm['courses.Semester']"}),
            'semester_winter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'winter_votes'", 'to': "orm['courses.Semester']"}),
            'vote_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 1, 1)'}),
            'vote_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 31)'}),
            'year': ('django.db.models.fields.IntegerField', [], {'default': '2012', 'unique': 'True'})
        }
    }
