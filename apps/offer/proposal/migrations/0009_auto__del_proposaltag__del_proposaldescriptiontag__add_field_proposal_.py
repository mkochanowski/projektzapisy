...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('proposal_proposal', 'description', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proposals_set', null=True, to=orm['proposal.ProposalDescription']), keep_default=False)
        ...
        db.alter_column('proposal_proposaldescription', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True, null=True))
    ...
    models = {
        ...
        'proposal.proposal': {
            ...
            'description': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'proposals_set'", 'null': 'True', 'to': "orm['proposal.ProposalDescription']"}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 15, 53, 24, 424838)'}),
