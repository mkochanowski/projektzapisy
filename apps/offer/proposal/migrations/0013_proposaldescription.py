...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for proposal in orm.Proposal.objects.filter():
            proposal.description = proposal.descriptions_set.order_by('-date')[0]
            proposal.save()
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 16, 26, 29, 265154)'}),
