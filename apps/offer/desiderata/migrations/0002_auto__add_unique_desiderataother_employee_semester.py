...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'DesiderataOther', fields ['employee', 'semester']
        db.create_unique('desiderata_desiderataother', ['employee_id', 'semester_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'DesiderataOther', fields ['employee', 'semester']
        db.delete_unique('desiderata_desiderataother', ['employee_id', 'semester_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 12, 33, 27, 148653)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 12, 33, 27, 148457)'}),
        ...
        'desiderata.desiderataother': {
            'Meta': {'unique_together': "(('employee', 'semester'),)", 'object_name': 'DesiderataOther'},
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 12, 33, 26, 995262)'}),
