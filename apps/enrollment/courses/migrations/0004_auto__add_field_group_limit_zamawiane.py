...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.limit_zamawiane'
        db.add_column('courses_group', 'limit_zamawiane', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Group.limit_zamawiane'
        db.delete_column('courses_group', 'limit_zamawiane')
