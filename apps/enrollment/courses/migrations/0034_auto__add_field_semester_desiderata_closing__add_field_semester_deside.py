...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Semester.desiderata_closing'
        db.add_column('courses_semester', 'desiderata_closing', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Semester.desiderata_opening'
        db.add_column('courses_semester', 'desiderata_opening', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Semester.desiderata_closing'
        db.delete_column('courses_semester', 'desiderata_closing')

        # Deleting field 'Semester.desiderata_opening'
        db.delete_column('courses_semester', 'desiderata_opening')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 19, 23, 19, 32, 416119)'}),
