...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEntity.status'
        db.add_column('courses_courseentity', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'CourseEntity.deleted'
        db.add_column('courses_courseentity', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'CourseEntity.owner'
        db.add_column('courses_courseentity', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Employee'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CourseEntity.status'
        db.delete_column('courses_courseentity', 'status')

        # Deleting field 'CourseEntity.deleted'
        db.delete_column('courses_courseentity', 'deleted')

        # Deleting field 'CourseEntity.owner'
        db.delete_column('courses_courseentity', 'owner_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 16, 22, 54, 7, 176154)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 16, 22, 54, 7, 176069)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 16, 22, 54, 6, 960701)'}),
