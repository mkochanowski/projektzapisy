...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Type.have_tutorial'
        db.add_column('courses_type', 'have_tutorial', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_review_lecture'
        db.add_column('courses_type', 'have_review_lecture', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_seminar'
        db.add_column('courses_type', 'have_seminar', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_lecture'
        db.add_column('courses_type', 'have_lecture', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_project'
        db.add_column('courses_type', 'have_project', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_lab'
        db.add_column('courses_type', 'have_lab', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Type.have_tutorial_lab'
        db.add_column('courses_type', 'have_tutorial_lab', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Semester.desiderata_closing'
        db.alter_column('courses_semester', 'desiderata_closing', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'Semester.desiderata_opening'
        db.alter_column('courses_semester', 'desiderata_opening', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Adding field 'CourseEntity.have_project'
        db.add_column('courses_courseentity', 'have_project', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_seminar'
        db.add_column('courses_courseentity', 'have_seminar', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_tutorial'
        db.add_column('courses_courseentity', 'have_tutorial', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_lab'
        db.add_column('courses_courseentity', 'have_lab', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_tutorial_lab'
        db.add_column('courses_courseentity', 'have_tutorial_lab', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_review_lecture'
        db.add_column('courses_courseentity', 'have_review_lecture', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.have_lecture'
        db.add_column('courses_courseentity', 'have_lecture', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Type.have_tutorial'
        db.delete_column('courses_type', 'have_tutorial')

        # Deleting field 'Type.have_review_lecture'
        db.delete_column('courses_type', 'have_review_lecture')

        # Deleting field 'Type.have_seminar'
        db.delete_column('courses_type', 'have_seminar')

        # Deleting field 'Type.have_lecture'
        db.delete_column('courses_type', 'have_lecture')

        # Deleting field 'Type.have_project'
        db.delete_column('courses_type', 'have_project')

        # Deleting field 'Type.have_lab'
        db.delete_column('courses_type', 'have_lab')

        # Deleting field 'Type.have_tutorial_lab'
        db.delete_column('courses_type', 'have_tutorial_lab')

        # Changing field 'Semester.desiderata_closing'
        db.alter_column('courses_semester', 'desiderata_closing', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Semester.desiderata_opening'
        db.alter_column('courses_semester', 'desiderata_opening', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 11, 47, 9, 524304)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 11, 47, 9, 524203)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 3, 11, 47, 9, 261157)'}),
