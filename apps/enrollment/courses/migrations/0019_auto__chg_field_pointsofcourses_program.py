...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PointsOfCourses.program'
        db.alter_column('courses_pointsofcourses', 'program_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Program'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'PointsOfCourses.program'
        db.alter_column('courses_pointsofcourses', 'program_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Program'], null=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 31, 14, 8, 14, 594572)'}),
