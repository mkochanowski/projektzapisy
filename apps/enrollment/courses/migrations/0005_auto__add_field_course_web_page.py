...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.web_page'
        db.add_column('courses_course', 'web_page', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Course.web_page'
        db.delete_column('courses_course', 'web_page')
