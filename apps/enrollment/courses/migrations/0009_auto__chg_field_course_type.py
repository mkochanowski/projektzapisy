...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('courses_course', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Type']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Course.type'
        db.alter_column('courses_course', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Type'], null=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 15, 19, 0, 58, 891537)'}),
