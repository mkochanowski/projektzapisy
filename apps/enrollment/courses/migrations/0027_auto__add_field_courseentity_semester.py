...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEntity.semester'
        db.add_column('courses_courseentity', 'semester', self.gf('django.db.models.fields.CharField')(default='u', max_length=1), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CourseEntity.semester'
        db.delete_column('courses_courseentity', 'semester')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 16, 14, 55, 461075)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 16, 14, 55, 460989)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 16, 14, 55, 319573)'}),
