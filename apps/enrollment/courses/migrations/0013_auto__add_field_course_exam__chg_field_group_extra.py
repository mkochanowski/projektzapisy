...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.extra'
        db.alter_column('courses_group', 'extra', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.extra'
        db.alter_column('courses_group', 'extra', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 8, 0, 15, 55, 944067)'}),
