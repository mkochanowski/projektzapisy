...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Group.extra'
        db.alter_column('courses_group', 'extra', self.gf('django.db.models.fields.CharField')(max_length=6))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 21, 54, 56, 108543)'}),
