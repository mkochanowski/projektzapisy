...
class Group(models.Model):
    ...
    def available_only_for_zamawiane(self, dont_use_cache=Fals):
    ...
    def get_count_of_enrolled(self, dont_use_cache=Fals):
    ...
    def get_count_of_enrolled_zamawiane(self, dont_use_cache=Fals):
        from apps.enrollment.records.models import Record
    ...
    def get_count_of_enrolled_non_zamawiane(self, dont_use_cache=Fals):
