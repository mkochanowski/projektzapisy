...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Classroom.building'
        db.add_column('subjects_classroom', 'building', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Classroom.capacity'
        db.add_column('subjects_classroom', 'capacity', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Classroom.building'
        db.delete_column('subjects_classroom', 'building')

        # Deleting field 'Classroom.capacity'
        db.delete_column('subjects_classroom', 'capacity')
    ...
    models = {
        ...
        'subjects.classroom': {
            ...
            'building': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
