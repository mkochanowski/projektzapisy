...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.building'
        db.alter_column('subjects_classroom', 'building', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Classroom.building'
        db.alter_column('subjects_classroom', 'building', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True))
