...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Semester.is_grade_active'
        db.add_column('subjects_semester', 'is_grade_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Semester.is_grade_active'
        db.delete_column('subjects_semester', 'is_grade_active')
