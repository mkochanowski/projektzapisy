...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Semester.year'
        db.alter_column('subjects_semester', 'year', self.gf('django.db.models.fields.CharField')(max_length=7))
    
    
    def backwards(self, orm):
        
        # Changing field 'Semester.year'
        db.alter_column('subjects_semester', 'year', self.gf('django.db.models.fields.PositiveIntegerField')())
