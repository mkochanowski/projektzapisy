...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PointsOfSubjects.program'
        db.add_column('subjects_pointsofsubjects', 'program', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Program'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'PointsOfSubjects.program'
        db.delete_column('subjects_pointsofsubjects', 'program_id')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'homepage': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
