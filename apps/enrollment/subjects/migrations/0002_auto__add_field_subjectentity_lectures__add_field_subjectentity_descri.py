...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubjectEntity.lectures'
        db.add_column('subjects_subjectentity', 'lectures', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SubjectEntity.description'
        db.add_column('subjects_subjectentity', 'description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'SubjectEntity.repetitions'
        db.add_column('subjects_subjectentity', 'repetitions', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SubjectEntity.exercises'
        db.add_column('subjects_subjectentity', 'exercises', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SubjectEntity.laboratories'
        db.add_column('subjects_subjectentity', 'laboratories', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'SubjectEntity.type'
        db.add_column('subjects_subjectentity', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subjects.Type'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubjectEntity.lectures'
        db.delete_column('subjects_subjectentity', 'lectures')

        # Deleting field 'SubjectEntity.description'
        db.delete_column('subjects_subjectentity', 'description')

        # Deleting field 'SubjectEntity.repetitions'
        db.delete_column('subjects_subjectentity', 'repetitions')

        # Deleting field 'SubjectEntity.exercises'
        db.delete_column('subjects_subjectentity', 'exercises')

        # Deleting field 'SubjectEntity.laboratories'
        db.delete_column('subjects_subjectentity', 'laboratories')

        # Deleting field 'SubjectEntity.type'
        db.delete_column('subjects_subjectentity', 'type_id')
