...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subject', fields ['semester', 'name']
        db.create_unique('subjects_subject', ['semester_id', 'name'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Subject', fields ['semester', 'name']
        db.delete_unique('subjects_subject', ['semester_id', 'name'])
