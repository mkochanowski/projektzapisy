...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Queue.edited'
        db.add_column('records_queue', 'edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 3, 0, 39, 36, 436042), blank=True), keep_default=False)

        # Changing field 'Queue.time'
        db.alter_column('records_queue', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Queue.edited'
        db.delete_column('records_queue', 'edited')

        # Changing field 'Queue.time'
        db.alter_column('records_queue', 'time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 0, 39, 36, 449796)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 0, 39, 36, 449606)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 0, 39, 26, 495541)'}),
