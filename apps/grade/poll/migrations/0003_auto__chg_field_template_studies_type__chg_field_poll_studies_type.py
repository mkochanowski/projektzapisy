...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.studies_type'
        db.alter_column('poll_template', 'studies_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Program'], null=True, blank=True))

        # Changing field 'Poll.studies_type'
        db.alter_column('poll_poll', 'studies_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Program'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Template.studies_type'
        db.alter_column('poll_template', 'studies_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Type'], null=True, blank=True))

        # Changing field 'Poll.studies_type'
        db.alter_column('poll_poll', 'studies_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Type'], null=True, blank=True))
