...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Template.share_result'
        db.delete_column('poll_template', 'share_result')

        # Adding field 'Template.no_subject'
        db.add_column('poll_template', 'no_subject', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Template.share_result'
        db.add_column('poll_template', 'share_result', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Template.no_subject'
        db.delete_column('poll_template', 'no_subject')
