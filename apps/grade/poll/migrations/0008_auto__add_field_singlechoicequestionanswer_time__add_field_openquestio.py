...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SingleChoiceQuestionAnswer.time'
        db.add_column('poll_singlechoicequestionanswer', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 6, 27, 11, 1, 35, 138927), blank=True), keep_default=False)

        # Adding field 'OpenQuestionAnswer.time'
        db.add_column('poll_openquestionanswer', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 6, 27, 11, 1, 40, 143925), blank=True), keep_default=False)

        # Adding field 'MultipleChoiceQuestionAnswer.time'
        db.add_column('poll_multiplechoicequestionanswer', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 6, 27, 11, 1, 42, 343362), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SingleChoiceQuestionAnswer.time'
        db.delete_column('poll_singlechoicequestionanswer', 'time')

        # Deleting field 'OpenQuestionAnswer.time'
        db.delete_column('poll_openquestionanswer', 'time')

        # Deleting field 'MultipleChoiceQuestionAnswer.time'
        db.delete_column('poll_multiplechoicequestionanswer', 'time')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 11, 1, 42, 364625)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 11, 1, 42, 364435)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 27, 10, 59, 50, 918205)'}),
