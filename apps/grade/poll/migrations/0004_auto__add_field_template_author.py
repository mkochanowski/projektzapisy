...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('poll_template', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.Employee']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Template.author'
        db.delete_column('poll_template', 'author_id')
