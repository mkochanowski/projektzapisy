...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudentGraded'
        db.create_table('ticket_create_studentgraded', (
        ...
        db.send_create_signal('ticket_create', ['StudentGraded'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'StudentGraded'
        db.delete_table('ticket_create_studentgraded')
    ...
    models = {
        ...
        'ticket_create.studentgraded': {
            'Meta': {'object_name': 'StudentGraded'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Semester']"}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Student']"})
        },
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 17, 10, 45, 56, 767775)'}),
