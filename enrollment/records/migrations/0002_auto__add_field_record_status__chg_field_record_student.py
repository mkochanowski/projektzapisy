...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Record.status'
        db.add_column('records_record', 'status', self.gf('django.db.models.fields.CharField')(default='1', max_length=1), keep_default=False)

        # Changing field 'Record.student'
        db.alter_column('records_record', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Student']))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Record.status'
        db.delete_column('records_record', 'status')

        # Changing field 'Record.student'
        db.alter_column('records_record', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
