...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('subjects_subject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Subject.slug'
        db.alter_column('subjects_subject', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True))
