...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Term.group'
        db.add_column('subjects_term', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subjects.Group'], null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'Term', fields ['classroom', 'start_time']
        db.create_unique('subjects_term', ['classroom_id', 'start_time'])

        # Adding unique constraint on 'Term', fields ['classroom', 'end_time']
        db.create_unique('subjects_term', ['classroom_id', 'end_time'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Term.group'
        db.delete_column('subjects_term', 'group_id')

        # Removing unique constraint on 'Term', fields ['classroom', 'start_time']
        db.delete_unique('subjects_term', ['classroom_id', 'start_time'])

        # Removing unique constraint on 'Term', fields ['classroom', 'end_time']
        db.delete_unique('subjects_term', ['classroom_id', 'end_time'])
