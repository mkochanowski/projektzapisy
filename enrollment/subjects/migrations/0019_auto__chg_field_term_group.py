...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Term.group'
        db.alter_column('subjects_term', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subjects.Group'], null=True, blank=True))
    ...
    models = {
        ...
        'subjects.term': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'terminy'", 'to': "orm['subjects.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
