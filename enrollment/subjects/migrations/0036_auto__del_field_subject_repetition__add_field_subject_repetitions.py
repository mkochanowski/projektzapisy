...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subject.repetition'
        db.delete_column('subjects_subject', 'repetition')

        # Adding field 'Subject.repetitions'
        db.add_column('subjects_subject', 'repetitions', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Subject.repetition'
        db.add_column('subjects_subject', 'repetition', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Subject.repetitions'
        db.delete_column('subjects_subject', 'repetitions')
