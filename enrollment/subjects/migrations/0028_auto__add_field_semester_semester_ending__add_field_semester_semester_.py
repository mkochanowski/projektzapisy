...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('subjects_semester', 'semester_ending', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Semester.semester_begining'
        db.add_column('subjects_semester', 'semester_begining', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)
