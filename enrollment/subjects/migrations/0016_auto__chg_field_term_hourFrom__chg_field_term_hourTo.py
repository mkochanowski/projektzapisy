...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Term.hourFrom'
        db.alter_column('subjects_term', 'hourFrom', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Term.hourTo'
        db.alter_column('subjects_term', 'hourTo', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        'subjects.term': {
            ...
            'hourFrom': ('django.db.models.fields.TimeField', [], {}),
            'hourTo': ('django.db.models.fields.TimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'subjects.type': {
