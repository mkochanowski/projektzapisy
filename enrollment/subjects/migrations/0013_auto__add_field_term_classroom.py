...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Term.classroom'
        db.add_column('subjects_term', 'classroom', self.gf('django.db.models.fields.related.ForeignKey')(default='141', to=orm['subjects.Classroom']), keep_default=False)

        # Removing M2M table for field classroom on 'Term'
        db.delete_table('subjects_term_classroom')
    
    
    def backwards(self, orm):
        
        # Deleting field 'Term.classroom'
        db.delete_column('subjects_term', 'classroom_id')

        # Adding M2M table for field classroom on 'Term'
        db.create_table('subjects_term_classroom', (
        ...
        db.create_unique('subjects_term_classroom', ['term_id', 'classroom_id'])
    ...
    models = {
        ...
        'subjects.term': {
            ...
            'classroom': ('django.db.models.fields.related.ForeignKey', [], {'default': "'141'", 'to': "orm['subjects.Classroom']"}),
