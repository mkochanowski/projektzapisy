...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Term.hourFrom'
        db.delete_column('subjects_term', 'hourFrom')

        # Deleting field 'Term.hourTo'
        db.delete_column('subjects_term', 'hourTo')

        # Adding field 'Term.start_time'
        db.add_column('subjects_term', 'start_time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(0, 0)), keep_default=False)

        # Adding field 'Term.end_time'
        db.add_column('subjects_term', 'end_time', self.gf('django.db.models.fields.TimeField')(default=datetime.time(0, 0)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Term.hourFrom'
        db.add_column('subjects_term', 'hourFrom', self.gf('django.db.models.fields.TimeField')(default=datetime.date(2010, 5, 17)), keep_default=False)

        # Adding field 'Term.hourTo'
        db.add_column('subjects_term', 'hourTo', self.gf('django.db.models.fields.TimeField')(default=datetime.date(2010, 5, 17)), keep_default=False)
