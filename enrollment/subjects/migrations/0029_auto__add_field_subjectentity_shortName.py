...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubjectEntity.shortName'
        db.add_column('subjects_subjectentity', 'shortName', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubjectEntity.shortName'
        db.delete_column('subjects_subjectentity', 'shortName')
