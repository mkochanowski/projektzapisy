...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Subject.ects'
        db.delete_column('subjects_subject', 'ects')
    
    
    def backwards(self, orm):
        
        # Adding field 'Subject.ects'
        db.add_column('subjects_subject', 'ects', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
