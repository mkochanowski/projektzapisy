...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('subjects_type', ['name'])

        # Adding field 'Semester.semester_ending'
        #db.add_column('subjects_semester', 'semester_ending', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 1, 23, 15, 23, 54, 418299), blank=True), keep_default=False)

        # Adding field 'Semester.semester_begining'
        #db.add_column('subjects_semester', 'semester_begining', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2011, 1, 23, 15, 24, 1, 298297), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'Type', fields ['name']
        db.create_unique('subjects_type', ['name'])

        # Deleting field 'Semester.semester_ending'
        #db.delete_column('subjects_semester', 'semester_ending')
