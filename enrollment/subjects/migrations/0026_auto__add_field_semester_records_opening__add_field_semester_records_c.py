...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Semester.records_opening'
        db.add_column('subjects_semester', 'records_opening', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Semester.records_closing'
        db.add_column('subjects_semester', 'records_closing', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Semester.records_opening'
        db.delete_column('subjects_semester', 'records_opening')

        # Deleting field 'Semester.records_closing'
        db.delete_column('subjects_semester', 'records_closing')
