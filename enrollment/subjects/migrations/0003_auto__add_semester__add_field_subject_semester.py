...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('subjects_semester', (
            ...
            ('year', self.gf('django.db.models.fields.PositiveIntegerField')(default=2010)),
        ))
        db.send_create_signal('subjects', ['Semester'])

        # Adding field 'Subject.semester'
        db.add_column('subjects_subject', 'semester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subjects.Semester'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subject.semester'
        db.delete_column('subjects_subject', 'semester_id')
