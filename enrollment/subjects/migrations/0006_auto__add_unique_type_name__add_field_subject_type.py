...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subject.type'
        db.add_column('subjects_subject', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subjects.Type'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subject.type'
        db.delete_column('subjects_subject', 'type_id')
