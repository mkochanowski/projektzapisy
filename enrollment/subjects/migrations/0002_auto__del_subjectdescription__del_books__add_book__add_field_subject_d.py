...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('subjects_subject', 'description', self.gf('django.db.models.fields.TextField')(default=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('subjects_subject', 'description')
