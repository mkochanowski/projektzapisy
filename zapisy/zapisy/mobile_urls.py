...
urlpatterns = [
    ...
    url(r'records/schedule/(?P<schedule_owner>\w+)/$',
        'apps.mobile.views.studentSchedule',
        name='student-schedule-owner'),
    url(r'records/schedule/(?P<schedule_owner>\w+)/(?P<delta>\-?\d+)/$',
        'apps.mobile.views.studentSchedule', name='student-schedule-delta'),
    ...
    url(r'employees/schedule/(?P<schedule_owner>\w+)/$',
        'apps.mobile.views.employeeSchedule',
        name='employee-schedule-owner'),
    url(r'employees/schedule/(?P<schedule_owner>\w+)/(?P<delta>\-?\d+)/$',
        'apps.mobile.views.employeeSchedule', name='employee-schedule-delta'),
