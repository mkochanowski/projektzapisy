...
PIPELINE_TYPESCRIPT_BINARY = getattr(settings, 'PIPELINE_TYPESCRIPT_BINARY', '/usr/bin/env tsc')
PIPELINE_TYPESCRIPT_ARGUMENTS = getattr(settings, 'PIPELINE_TYPESCRIPT_ARGUMENTS', '')
