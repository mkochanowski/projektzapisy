...
urlpatterns = [
    ...
    url('^profile/employee/(?P<user_id>(\d+))?$', views.employee_profile, name='employee-profile'),
    url('^profile/student/(?P<user_id>(\d+))?$', views.student_profile, name='student-profile'),
