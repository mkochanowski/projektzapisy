...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudiaZamawiane.bank_account'
        db.alter_column('users_studiazamawiane', 'bank_account', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True))

        # Changing field 'StudiaZamawiane.comments'
        db.alter_column('users_studiazamawiane', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'StudiaZamawiane.bank_account'
        db.alter_column('users_studiazamawiane', 'bank_account', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True))

        # Changing field 'StudiaZamawiane.comments'
        db.alter_column('users_studiazamawiane', 'comments', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 21, 19, 36, 35, 813787)'}),
