...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Employee.consultations'
        db.alter_column('users_employee', 'consultations', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Employee.homepage'
        db.alter_column('users_employee', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'consultations': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'homepage': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '200', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 31, 22, 46, 55, 582831)'}),
