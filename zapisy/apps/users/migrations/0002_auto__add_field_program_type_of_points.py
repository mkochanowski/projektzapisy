...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Program.type_of_points'
        db.add_column('users_program', 'type_of_points', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['courses.PointTypes']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Program.type_of_points'
        db.delete_column('users_program', 'type_of_points_id')
