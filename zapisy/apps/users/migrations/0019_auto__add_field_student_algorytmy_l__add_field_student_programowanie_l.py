...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.algorytmy_l'
        db.add_column('users_student', 'algorytmy_l',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Student.programowanie_l'
        db.add_column('users_student', 'programowanie_l',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.algorytmy_l'
        db.delete_column('users_student', 'algorytmy_l')

        # Deleting field 'Student.programowanie_l'
        db.delete_column('users_student', 'programowanie_l')
    ...
    models = {
        ...
        'users.coursepoints': {
            'Meta': {'object_name': 'CoursePoints', 'managed': 'False'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Course']"}),
