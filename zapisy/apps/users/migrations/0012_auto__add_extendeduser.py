...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_extendeduser', (
            ('is_employee', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('user_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('is_zamawiany', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('is_student', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('users', ['ExtendedUser'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ExtendedUser'
        db.delete_table('users_extendeduser')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 13, 13, 57, 2, 115525)'}),
