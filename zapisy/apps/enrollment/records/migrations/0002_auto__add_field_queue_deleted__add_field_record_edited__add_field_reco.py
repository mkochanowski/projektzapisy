...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('records_queue', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Record.edited'
        db.add_column('records_record', 'edited', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 2, 17, 47, 18, 880538), blank=True), keep_default=False)

        # Adding field 'Record.created'
        db.add_column('records_record', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 2, 17, 47, 28, 124400), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Queue.deleted'
        db.delete_column('records_queue', 'deleted')

        # Deleting field 'Record.edited'
        db.delete_column('records_record', 'edited')

        # Deleting field 'Record.created'
        db.delete_column('records_record', 'created')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 17, 47, 28, 128329)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 17, 47, 28, 128149)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 2, 17, 47, 10, 770941)'}),
