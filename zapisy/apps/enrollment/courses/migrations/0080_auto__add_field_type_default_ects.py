...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Type.default_ects'
        db.add_column('courses_type', 'default_ects',
                      self.gf('django.db.models.fields.IntegerField')(default=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Type.default_ects'
        db.delete_column('courses_type', 'default_ects')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 30, 0, 0)'}),
