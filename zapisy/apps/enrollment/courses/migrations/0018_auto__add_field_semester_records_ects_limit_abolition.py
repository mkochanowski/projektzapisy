...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Semester.records_ects_limit_abolition'
        db.add_column('courses_semester', 'records_ects_limit_abolition', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Semester.records_ects_limit_abolition'
        db.delete_column('courses_semester', 'records_ects_limit_abolition')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 27, 16, 15, 56, 632644)'}),
