...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseDescription.created'
        db.add_column('courses_coursedescription', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 1, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseDescription.created'
        db.delete_column('courses_coursedescription', 'created')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 15, 0, 0)'}),
