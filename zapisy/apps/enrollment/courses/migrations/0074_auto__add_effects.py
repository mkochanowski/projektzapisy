...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Effects'
        db.create_table('courses_effects', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('courses', ['Effects'])

        # Adding M2M table for field effects on 'CourseEntity'
        db.create_table('courses_courseentity_effects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('courseentity', models.ForeignKey(orm['courses.courseentity'], null=False)),
            ('effects', models.ForeignKey(orm['courses.effects'], null=False))
        ))
        db.create_unique('courses_courseentity_effects', ['courseentity_id', 'effects_id'])


    def backwards(self, orm):
        # Deleting model 'Effects'
        db.delete_table('courses_effects')

        # Removing M2M table for field effects on 'CourseEntity'
        db.delete_table('courses_courseentity_effects')
    ...
    models = {
        ...
        'courses.courseentity': {
            ...
            'effects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['courses.Effects']", 'symmetrical': 'False'}),
            'english': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 20, 0, 0)'}),
