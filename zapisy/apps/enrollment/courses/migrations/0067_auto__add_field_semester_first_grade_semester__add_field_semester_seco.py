...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.first_grade_semester'
        db.add_column('courses_semester', 'first_grade_semester',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='fgrade', null=True, to=orm['courses.Semester']),
                      keep_default=False)

        # Adding field 'Semester.second_grade_semester'
        db.add_column('courses_semester', 'second_grade_semester',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sgrade', null=True, to=orm['courses.Semester']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.first_grade_semester'
        db.delete_column('courses_semester', 'first_grade_semester_id')

        # Deleting field 'Semester.second_grade_semester'
        db.delete_column('courses_semester', 'second_grade_semester_id')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 22, 0, 0)'}),
