...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseDescription.lectures'
        db.delete_column('courses_coursedescription', 'lectures')

        # Changing field 'CourseDescription.repetitions'
        db.delete_column('courses_coursedescription', 'repetitions')

        # Changing field 'CourseDescription.seminars'
        db.delete_column('courses_coursedescription', 'seminars')

        # Changing field 'CourseDescription.exercises'
        db.delete_column('courses_coursedescription', 'exercises')

        # Changing field 'CourseDescription.laboratories'
        db.delete_column('courses_coursedescription', 'laboratories')

        # Changing field 'CourseDescription.exercises_laboratories'
        db.delete_column('courses_coursedescription', 'exercises_laboratories')


        # Changing field 'CourseDescription.lectures'
        db.add_column('courses_coursedescription', 'lectures', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CourseDescription.repetitions'
        db.add_column('courses_coursedescription', 'repetitions', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CourseDescription.seminars'
        db.add_column('courses_coursedescription', 'seminars', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CourseDescription.exercises'
        db.add_column('courses_coursedescription', 'exercises', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CourseDescription.laboratories'
        db.add_column('courses_coursedescription', 'laboratories', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CourseDescription.exercises_laboratories'
        db.add_column('courses_coursedescription', 'exercises_laboratories', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
