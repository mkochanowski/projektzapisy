...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEntity.exam'
        db.add_column('courses_courseentity', 'exam', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.english'
        db.add_column('courses_courseentity', 'english', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding M2M table for field requirements on 'CourseEntity'
        db.create_table('courses_courseentity_requirements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_courseentity', models.ForeignKey(orm['courses.courseentity'], null=False)),
            ('to_courseentity', models.ForeignKey(orm['courses.courseentity'], null=False))
        ))
        db.create_unique('courses_courseentity_requirements', ['from_courseentity_id', 'to_courseentity_id'])

        # Changing field 'CourseEntity.description'
        db.alter_column('courses_courseentity', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'CourseEntity.shortName'
        db.alter_column('courses_courseentity', 'shortName', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'CourseEntity.exam'
        db.delete_column('courses_courseentity', 'exam')

        # Deleting field 'CourseEntity.english'
        db.delete_column('courses_courseentity', 'english')

        # Removing M2M table for field requirements on 'CourseEntity'
        db.delete_table('courses_courseentity_requirements')

        # Changing field 'CourseEntity.description'
        db.alter_column('courses_courseentity', 'description', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'CourseEntity.shortName'
        db.alter_column('courses_courseentity', 'shortName', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 42, 39, 652795)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 42, 39, 652696)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 42, 39, 411368)'}),
