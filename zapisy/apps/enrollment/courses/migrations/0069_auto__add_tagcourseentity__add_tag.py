...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagCourseEntity'
        db.create_table('courses_tagcourseentity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Tag'])),
            ('courseentity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.CourseEntity'])),
            ('weight', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('courses', ['TagCourseEntity'])

        # Adding model 'Tag'
        db.create_table('courses_tag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('courses', ['Tag'])


    def backwards(self, orm):
        # Deleting model 'TagCourseEntity'
        db.delete_table('courses_tagcourseentity')

        # Deleting model 'Tag'
        db.delete_table('courses_tag')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 16, 0, 0)'}),
