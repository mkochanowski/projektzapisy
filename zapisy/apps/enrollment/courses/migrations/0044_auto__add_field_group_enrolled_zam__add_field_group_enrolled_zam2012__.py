...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.enrolled_zam'
        #db.add_column('courses_group', 'enrolled_zam', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Group.enrolled_zam2012'
        db.add_column('courses_group', 'enrolled_zam2012', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Group.limit_zamawiane2012'
        db.add_column('courses_group', 'limit_zamawiane2012', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)

        # Adding field 'Group.enrolled'
        #db.add_column('courses_group', 'enrolled', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Group.queued'
        #db.add_column('courses_group', 'queued', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Group.enrolled_zam'
        #db.delete_column('courses_group', 'enrolled_zam')

        # Deleting field 'Group.enrolled_zam2012'
        db.delete_column('courses_group', 'enrolled_zam2012')

        # Deleting field 'Group.limit_zamawiane2012'
        db.delete_column('courses_group', 'limit_zamawiane2012')

        # Deleting field 'Group.enrolled'
        #db.delete_column('courses_group', 'enrolled')

        # Deleting field 'Group.queued'
        #db.delete_column('courses_group', 'queued')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 12, 57, 50, 409057)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 12, 57, 50, 408967)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 6, 12, 57, 50, 190475)'}),
