...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for c in orm['courses.CourseEntity'].objects.filter(status__in=[2,3]):
            c.status = 1
            c.save()
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 20, 0, 0)'}),
