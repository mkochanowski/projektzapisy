...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.records_ending'
        db.add_column('courses_semester', 'records_ending',
    ...
    def backwards(self, orm):
        # Deleting field 'Semester.records_ending'
        db.delete_column('courses_semester', 'records_ending')

        # Adding field 'Group.cache_enrolled'
        db.add_column('courses_group', 'cache_enrolled',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.cache_enrolled_zam'
        db.add_column('courses_group', 'cache_enrolled_zam',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.cache_queued'
        db.add_column('courses_group', 'cache_queued',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 1, 0, 0)'}),
