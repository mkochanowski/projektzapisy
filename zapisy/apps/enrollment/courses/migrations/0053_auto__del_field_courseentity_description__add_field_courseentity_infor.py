...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseEntity.description'
        db.delete_column('courses_courseentity', 'description')

        # Adding field 'CourseEntity.information'
        db.add_column('courses_courseentity', 'information',
    ...
    def backwards(self, orm):
        # Adding field 'CourseEntity.description'
        db.add_column('courses_courseentity', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CourseEntity.information'
        db.delete_column('courses_courseentity', 'information_id')
