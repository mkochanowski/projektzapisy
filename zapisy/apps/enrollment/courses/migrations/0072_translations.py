...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for entity in orm.CourseEntity.objects.all():
            entity.name_pl = entity.name
            print entity.name
            entity.save()


        for entity in orm.CourseDescription.objects.all():
            entity.description_pl = entity.description
