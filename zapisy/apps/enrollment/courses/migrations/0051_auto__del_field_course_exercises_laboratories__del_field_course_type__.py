...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Course', fields ['semester', 'name']
        db.delete_unique('courses_course', ['semester_id', 'name'])

        # Deleting field 'Course.exercises_laboratories'
        db.delete_column('courses_course', 'exercises_laboratories')

        # Deleting field 'Course.type'
        db.delete_column('courses_course', 'type_id')

        # Deleting field 'Course.lectures'
        db.delete_column('courses_course', 'lectures')

        # Deleting field 'Course.description'
        db.delete_column('courses_course', 'description')

        # Deleting field 'Course.repetitions'
        db.delete_column('courses_course', 'repetitions')

        # Deleting field 'Course.exercises'
        db.delete_column('courses_course', 'exercises')

        # Deleting field 'Course.name'
        db.delete_column('courses_course', 'name')

        # Deleting field 'Course.seminars'
        db.delete_column('courses_course', 'seminars')

        # Deleting field 'Course.laboratories'
        db.delete_column('courses_course', 'laboratories')

        # Removing M2M table for field requirements on 'Course'
        db.delete_table('courses_course_requirements')

        # Adding field 'CourseEntity.exercises_laboratiories'
        db.add_column('courses_courseentity', 'exercises_laboratiories',
    ...
    def backwards(self, orm):
        # Adding field 'Course.exercises_laboratories'
        db.add_column('courses_course', 'exercises_laboratories',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Course.type'
        raise RuntimeError("Cannot reverse this migration. 'Course.type' and its values cannot be restored.")
        # Adding field 'Course.lectures'
        db.add_column('courses_course', 'lectures',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Course.description'
        db.add_column('courses_course', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Course.repetitions'
        db.add_column('courses_course', 'repetitions',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding field 'Course.exercises'
        db.add_column('courses_course', 'exercises',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)
        ...
        db.add_column('courses_course', 'seminars',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.laboratories'
        db.add_column('courses_course', 'laboratories',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)

        # Adding M2M table for field requirements on 'Course'
        db.create_table('courses_course_requirements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('courseentity', models.ForeignKey(orm['courses.courseentity'], null=False))
        ))
        db.create_unique('courses_course_requirements', ['course_id', 'courseentity_id'])

        # Adding unique constraint on 'Course', fields ['semester', 'name']
        db.create_unique('courses_course', ['semester_id', 'name'])

        # Deleting field 'CourseEntity.exercises_laboratiories'
        db.delete_column('courses_courseentity', 'exercises_laboratiories')
