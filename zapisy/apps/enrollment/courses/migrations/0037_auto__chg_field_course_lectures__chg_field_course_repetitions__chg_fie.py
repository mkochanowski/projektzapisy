...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.lectures'
        db.alter_column('courses_course', 'lectures', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.repetitions'
        db.alter_column('courses_course', 'repetitions', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.exercises'
        db.alter_column('courses_course', 'exercises', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.laboratories'
        db.alter_column('courses_course', 'laboratories', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Course.exercises_laboratories'
        db.alter_column('courses_course', 'exercises_laboratories', self.gf('django.db.models.fields.IntegerField')(null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Course.lectures'
        db.alter_column('courses_course', 'lectures', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.repetitions'
        db.alter_column('courses_course', 'repetitions', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.exercises'
        db.alter_column('courses_course', 'exercises', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.laboratories'
        db.alter_column('courses_course', 'laboratories', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Course.exercises_laboratories'
        db.alter_column('courses_course', 'exercises_laboratories', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 16, 24, 15, 75955)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 16, 24, 15, 75736)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 12, 16, 24, 13, 958896)'}),
