...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEntity.edited'
        db.add_column('courses_courseentity', 'edited', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2012, 5, 26), blank=True), keep_default=False)

        # Adding field 'CourseEntity.created'
        db.add_column('courses_courseentity', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2012, 5, 26), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CourseEntity.edited'
        db.delete_column('courses_courseentity', 'edited')

        # Deleting field 'CourseEntity.created'
        db.delete_column('courses_courseentity', 'created')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 21, 32, 21, 901521)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 21, 32, 21, 901358)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 21, 31, 50, 749610)'}),
