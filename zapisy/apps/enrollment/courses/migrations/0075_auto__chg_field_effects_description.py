...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Effects.description'
        db.alter_column('courses_effects', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Effects.description'
        db.alter_column('courses_effects', 'description', self.gf('django.db.models.fields.TextField')(default=' '))
