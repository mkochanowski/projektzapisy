...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Term.classroom'
        db.alter_column('courses_term', 'classroom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Classroom'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Term.classroom'
        db.alter_column('courses_term', 'classroom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Classroom']))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 1, 9, 33, 26, 80363)'}),
