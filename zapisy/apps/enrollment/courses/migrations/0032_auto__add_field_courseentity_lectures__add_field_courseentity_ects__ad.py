...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CourseEntity.lectures'
        db.add_column('courses_courseentity', 'lectures', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.ects'
        db.add_column('courses_courseentity', 'ects', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.repetitions'
        db.add_column('courses_courseentity', 'repetitions', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.exercises'
        db.add_column('courses_courseentity', 'exercises', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'CourseEntity.laboratories'
        db.add_column('courses_courseentity', 'laboratories', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CourseEntity.lectures'
        db.delete_column('courses_courseentity', 'lectures')

        # Deleting field 'CourseEntity.ects'
        db.delete_column('courses_courseentity', 'ects')

        # Deleting field 'CourseEntity.repetitions'
        db.delete_column('courses_courseentity', 'repetitions')

        # Deleting field 'CourseEntity.exercises'
        db.delete_column('courses_courseentity', 'exercises')

        # Deleting field 'CourseEntity.laboratories'
        db.delete_column('courses_courseentity', 'laboratories')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 1, 9, 10, 869126)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 1, 9, 10, 869037)'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 1, 9, 10, 759344)'}),
