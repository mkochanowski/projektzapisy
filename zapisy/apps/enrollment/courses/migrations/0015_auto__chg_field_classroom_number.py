...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classroom.number'
        db.alter_column('courses_classroom', 'number', self.gf('django.db.models.fields.CharField')(max_length=20))
    
    
    def backwards(self, orm):
        
        # Changing field 'Classroom.number'
        db.alter_column('courses_classroom', 'number', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 16, 23, 58, 28, 584551)'}),
