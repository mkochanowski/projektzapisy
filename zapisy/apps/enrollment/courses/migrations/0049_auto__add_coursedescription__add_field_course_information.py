...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('courses_coursedescription', (
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Type'])),
            ('description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('lectures', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('repetitions', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('exercises', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('laboratories', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('exercises_laboratories', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('seminars', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('exam', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('courses', ['CourseDescription'])

        # Adding M2M table for field requirements on 'CourseDescription'
        db.create_table('courses_coursedescription_requirements', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coursedescription', models.ForeignKey(orm['courses.coursedescription'], null=False)),
            ('courseentity', models.ForeignKey(orm['courses.courseentity'], null=False))
        ))
        db.create_unique('courses_coursedescription_requirements', ['coursedescription_id', 'courseentity_id'])

        # Adding field 'Course.information'
        db.add_column('courses_course', 'information',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.CourseDescription'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CourseDescription'
        db.delete_table('courses_coursedescription')

        # Removing M2M table for field requirements on 'CourseDescription'
        db.delete_table('courses_coursedescription_requirements')

        # Deleting field 'Course.information'
        db.delete_column('courses_course', 'information_id')
    ...
    models = {
        ...
        'courses.course': {
            'Meta': {'ordering': "['name']", 'unique_together': "(('name', 'semester'),)", 'object_name': 'Course'},
            ...
            'requirements': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'requiments'", 'blank': 'True', 'to': "orm['courses.CourseEntity']"}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 29, 0, 0)'}),
