...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.limit_isim'
        db.add_column('courses_group', 'limit_isim',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.limit_isim'
        db.delete_column('courses_group', 'limit_isim')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 19, 0, 0)'}),
