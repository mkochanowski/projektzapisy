...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangedDay'
        db.create_table('courses_changedday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.DateField')()),
            ('weekday', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('courses', ['ChangedDay'])

        # Adding model 'Freeday'
        db.create_table('courses_freeday', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('courses', ['Freeday'])


    def backwards(self, orm):
        # Deleting model 'ChangedDay'
        db.delete_table('courses_changedday')

        # Deleting model 'Freeday'
        db.delete_table('courses_freeday')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 24, 0, 0)'}),
