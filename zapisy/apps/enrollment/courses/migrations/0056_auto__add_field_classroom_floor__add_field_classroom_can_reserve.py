...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Classroom.floor'
        db.add_column('courses_classroom', 'floor',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Classroom.can_reserve'
        db.add_column('courses_classroom', 'can_reserve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Classroom.floor'
        db.delete_column('courses_classroom', 'floor')

        # Deleting field 'Classroom.can_reserve'
        db.delete_column('courses_classroom', 'can_reserve')
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 0, 0)'}),
