...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.extra'
        db.add_column('courses_group', 'extra', self.gf('django.db.models.fields.CharField')(default='', max_length=6), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Group.extra'
        db.delete_column('courses_group', 'extra')

        # Changing field 'CourseEntity.description'
        db.alter_column('courses_courseentity', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'courses.group': {
            ...
            'extra': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '6'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 20, 28, 52, 983630)'}),
