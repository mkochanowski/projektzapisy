...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Type.short_name'
        db.add_column('courses_type', 'short_name', self.gf('django.db.models.fields.CharField')(default='', max_length=5), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Type.short_name'
        db.delete_column('courses_type', 'short_name')
