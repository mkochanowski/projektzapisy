...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field classrooms on 'Term'
        db.create_table('courses_term_classrooms', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('term', models.ForeignKey(orm['courses.term'], null=False)),
            ('classroom', models.ForeignKey(orm['courses.classroom'], null=False))
        ))
        db.create_unique('courses_term_classrooms', ['term_id', 'classroom_id'])
    
    
    def backwards(self, orm):
        
        # Removing M2M table for field classrooms on 'Term'
        db.delete_table('courses_term_classrooms')
    ...
    models = {
        ...
        'courses.term': {
            ...
            'classrooms': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'new_classrooms'", 'symmetrical': 'False', 'to': "orm['courses.Classroom']"}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 20, 19, 38, 26, 396307)'}),
