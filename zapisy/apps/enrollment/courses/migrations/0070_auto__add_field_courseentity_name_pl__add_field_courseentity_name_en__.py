...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEntity.name_pl'
        db.add_column('courses_courseentity', 'name_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseEntity.name_en'
        db.add_column('courses_courseentity', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseEntity.shortName_pl'
        db.add_column('courses_courseentity', 'shortName_pl',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseEntity.shortName_en'
        db.add_column('courses_courseentity', 'shortName_en',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseDescription.description_pl'
        db.add_column('courses_coursedescription', 'description_pl',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseDescription.description_en'
        db.add_column('courses_coursedescription', 'description_en',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEntity.name_pl'
        db.delete_column('courses_courseentity', 'name_pl')

        # Deleting field 'CourseEntity.name_en'
        db.delete_column('courses_courseentity', 'name_en')

        # Deleting field 'CourseEntity.shortName_pl'
        db.delete_column('courses_courseentity', 'shortName_pl')

        # Deleting field 'CourseEntity.shortName_en'
        db.delete_column('courses_courseentity', 'shortName_en')

        # Deleting field 'CourseDescription.description_pl'
        db.delete_column('courses_coursedescription', 'description_pl')

        # Deleting field 'CourseDescription.description_en'
        db.delete_column('courses_coursedescription', 'description_en')
    ...
    models = {
        ...
        'courses.courseentity': {
            ...
            'shortName_en': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'shortName_pl': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
        ...
        'courses.studentpointsview': {
            'Meta': {'object_name': 'StudentPointsView', 'managed': 'False'},
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.CourseEntity']"}),
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 17, 0, 0)'}),
