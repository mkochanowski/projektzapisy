...
from zapisy.apps.enrollment.courses.models import Freeday

class Migration(SchemaMigration):

    def forwards(self, orm):
        # Deleting duplicates
        for fd in Freeday.objects.all():
            if Freeday.objects.filter(day=fd.day).count() > 1:
                fd.delete()
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 27, 0, 0)'}),
