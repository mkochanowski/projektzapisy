...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PointsOfCourseEntities', fields ['type_of_point', 'entity']
        db.delete_unique('courses_pointsofcourseentities', ['type_of_point_id', 'entity_id'])

        # Deleting model 'PointsOfCourses'
        db.delete_table('courses_pointsofcourses')

        # Adding field 'Course.notes'
        db.add_column('courses_course', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PointsOfCourseEntities.program'
        db.add_column('courses_pointsofcourseentities', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Program'], null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'PointsOfCourseEntities', fields ['program', 'type_of_point', 'entity']
        db.create_unique('courses_pointsofcourseentities', ['program_id', 'type_of_point_id', 'entity_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PointsOfCourseEntities', fields ['program', 'type_of_point', 'entity']
        db.delete_unique('courses_pointsofcourseentities', ['program_id', 'type_of_point_id', 'entity_id'])
        ...
        db.create_table('courses_pointsofcourses', (
            ...
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['users.Program'], null=True, blank=True)),
        ...
        db.delete_column('courses_course', 'notes')

        # Deleting field 'PointsOfCourseEntities.program'
        db.delete_column('courses_pointsofcourseentities', 'program_id')

        # Adding unique constraint on 'PointsOfCourseEntities', fields ['type_of_point', 'entity']
        db.create_unique('courses_pointsofcourseentities', ['type_of_point_id', 'entity_id'])
