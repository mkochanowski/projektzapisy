...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.lectures_beginning'
        db.add_column('courses_semester', 'lectures_beginning',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Semester.lectures_ending'
        db.add_column('courses_semester', 'lectures_ending',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.lectures_beginning'
        db.delete_column('courses_semester', 'lectures_beginning')

        # Deleting field 'Semester.lectures_ending'
        db.delete_column('courses_semester', 'lectures_ending')
