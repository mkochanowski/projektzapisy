...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SystemState.correction_beg'
        db.delete_column('vote_systemstate', 'correction_beg')

        # Deleting field 'SystemState.correction_end'
        db.delete_column('vote_systemstate', 'correction_end')


        # Changing field 'SingleVote.course'
        db.alter_column('vote_singlevote', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Adding field 'SystemState.correction_beg'
        db.add_column('vote_systemstate', 'correction_beg',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 1, 1)),
                      keep_default=False)

        # Adding field 'SystemState.correction_end'
        db.add_column('vote_systemstate', 'correction_end',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 7, 31)),
                      keep_default=False)


        # Changing field 'SingleVote.course'
        db.alter_column('vote_singlevote', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'], null=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 12, 7, 0, 0)'}),
        ...
        'vote.singlevote': {
            'Meta': {'ordering': "('student', 'entity', '-value')", 'unique_together': "(('course', 'state', 'student'),)", 'object_name': 'SingleVote'},
            'correction': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Course']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.CourseEntity']"}),
            'free_vote': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'vote.systemstate': {
            ...
            'summer_correction_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 0, 0)'}),
            'summer_correction_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
            'vote_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
            'vote_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 10, 0, 0)'}),
            'winter_correction_beg': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 1, 0, 0)'}),
            'winter_correction_end': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)'}),
