...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SystemState', fields ['year']
        db.delete_unique('vote_systemstate', ['year'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'SystemState', fields ['year']
        db.create_unique('vote_systemstate', ['year'])
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 26, 23, 11, 9, 333363)'}),
