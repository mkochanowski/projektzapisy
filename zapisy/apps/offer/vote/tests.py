...
def create_inactive_system_state():
    SystemState.objects.create(
...
def generic_voting_inactive_view_test_case(urlname, testcase):
    create_inactive_system_state()
    create_and_login_student(testcase)
    response = testcase.client.get(reverse(urlname))
...
class VoteViewTestCase(TestCase):
    ...
    def test_vote_link_when_system_is_inactive(self):
        generic_voting_inactive_view_test_case('vote-view', self)
...
class VoteSummaryViewTestCase(TestCase):
    ...
    def test_vote_link_when_system_is_inactive(self):
        generic_voting_inactive_view_test_case('vote-summary', self)
