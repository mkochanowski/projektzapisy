...
EMPLOYEE_MAP.update({key: 'NN' for key in UNKNOWN_EMPLOYEES})

COURSES_MAP = {
    'WARSZTATY DEEP LEARNING': 'WARSZTATY: DEEP LEARNING',
    'MATEMATYKA DYSKRETNA L': 'MATEMATYKA DYSKRETNA (L)',
    'MATEMATYKA DYSKRETNA M': 'MATEMATYKA DYSKRETNA (M)',
    'OCHRONA WŁASNOŚCI INTELEKTUALNEJ (LATO)': 'OCHRONA WŁASNOŚCI INTELEKTUALNEJ',
    'PROJEKT DYPLOMOWY (LATO)': 'PROJEKT DYPLOMOWY',
    'PROJEKT: BUDOWA I ROZWÓJ ANALOGU ŁAZIKA MARSJAŃSKIEGO (LATO)': 'PROJEKT: BUDOWA I ROZWÓJ ANALOGU ŁAZIKA MARSJAŃSKIEGO',
    'PROJEKT: ROZWÓJ SCHEDULERA (LATO)': 'PROJEKT: ROZWÓJ SCHEDULERA',
    'PROJEKT: ROZWÓJ SYSTEMU ZAPISÓW (LATO)': 'PROJEKT: ROZWÓJ SYSTEMU ZAPISÓW',
    'MENTORING FOR DATA SCIENCE (LATO)': 'MENTORING FOR DATA SCIENCE',
    'TUTORING INFORMATYKA (LATO)': 'TUTORING',
    'TUTORING ISIM (LATO)': 'TUTORING ISIM',
    'ANALIZA NUMERYCZNA L': 'ANALIZA NUMERYCZNA (L)',
    'ANALIZA NUMERYCZNA M': 'ANALIZA NUMERYCZNA (M)',
    'INNOVATIVE PROJECTS BY NOKIA (LATO)': 'INNOVATIVE PROJECTS BY NOKIA',
