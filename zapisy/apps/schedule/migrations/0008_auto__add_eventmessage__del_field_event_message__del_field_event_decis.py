...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventMessage'
        db.create_table('schedule_eventmessage', (
        ...
        db.send_create_signal('schedule', ['EventMessage'])

        # Deleting field 'Event.message'
        db.delete_column('schedule_event', 'message')

        # Deleting field 'Event.decision'
        db.delete_column('schedule_event', 'decision')


    def backwards(self, orm):
        # Deleting model 'EventMessage'
        db.delete_table('schedule_eventmessage')

        # Adding field 'Event.message'
        db.add_column('schedule_event', 'message',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.decision'
        db.add_column('schedule_event', 'decision',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 27, 0, 0)'}),
