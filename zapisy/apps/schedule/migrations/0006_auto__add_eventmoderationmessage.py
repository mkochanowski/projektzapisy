...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventModerationMessage'
        db.create_table('schedule_eventmoderationmessage', (
        ...
        db.send_create_signal('schedule', ['EventModerationMessage'])


    def backwards(self, orm):
        # Deleting model 'EventModerationMessage'
        db.delete_table('schedule_eventmoderationmessage')
