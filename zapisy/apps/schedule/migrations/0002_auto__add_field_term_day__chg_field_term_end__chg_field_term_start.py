...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Term.day'
        db.add_column('schedule_term', 'day',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 12, 19, 0, 0)),
                      keep_default=False)


        # Changing field 'Term.end'

        db.delete_column('schedule_term', 'end')
        db.delete_column('schedule_term', 'start')

        # Changing field 'Term.start'

        db.add_column('schedule_term', 'start', self.gf('timedelta.fields.TimedeltaField')())
        db.add_column('schedule_term', 'end', self.gf('timedelta.fields.TimedeltaField')())

    def backwards(self, orm):
        # Deleting field 'Term.day'
        db.delete_column('schedule_term', 'day')


        # Changing field 'Term.end'
        db.alter_column('schedule_term', 'end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Term.start'
        db.alter_column('schedule_term', 'start', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'schedule.term': {
            'Meta': {'ordering': "['start', 'end']", 'object_name': 'Term'},
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 19, 0, 0)'}),
