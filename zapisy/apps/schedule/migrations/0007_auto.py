...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field interested on 'Event'
        db.create_table('schedule_event_interested', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['schedule.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('schedule_event_interested', ['event_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field interested on 'Event'
        db.delete_table('schedule_event_interested')
