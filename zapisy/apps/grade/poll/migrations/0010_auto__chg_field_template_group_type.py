...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.group_type'
        db.alter_column('poll_template', 'group_type', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Template.group_type'
        raise RuntimeError("Cannot reverse this migration. 'Template.group_type' and its values cannot be restored.")
    ...
    models = {
        ...
        'poll.poll': {
            'Meta': {'ordering': "['group__course__entity__name', 'group__teacher']", 'object_name': 'Poll'},
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 0, 0)'}),
