...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.course'
        db.alter_column('poll_template', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.CourseEntity'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Template.course'
        db.alter_column('poll_template', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'], null=True, blank=True))
    ...
    models = {
        ...
        'users.employee': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_news_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 15, 19, 21, 34, 651187)'}),
