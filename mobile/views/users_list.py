...
from fereol.users.exceptions import NonUserException, NonEmployeeException, NonStudentException
from fereol.users.models import Employee, Student

from fereol.users.forms import EmailChangeForm
...
def studentsList(request, key=None):
    ...
    students = {
    '1' : students.filter(Q(user__last_name__startswith='Æ') | Q(user__last_name__startswith='£') | Q(user__last_name__startswith='Œ')),
