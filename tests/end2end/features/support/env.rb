...
Capybara.register_driver :selenium_remote_ie do |app|
   Capybara::Driver::Selenium.new(app, :browser => :remote, :desired_capabilities => :internet_explorer,
                                       :url => "http://fereol-ci.ii.uni.wroc.pl:4044/wd/hub")
end
...
if ENV['BROWSER'] == "ie"
   ...
   Capybara.app_host = "http://10.0.2.2:4026"
   # w tym przypadku trzeba odpalać gunicorn_django z parametrem 0.0.0.0:8000, aby aplikacja przyjmowała żądania spoza localhosta
