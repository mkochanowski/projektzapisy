...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proposal.owner'
        db.alter_column('proposal_proposal', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['auth.User']))
    
    
    def backwards(self, orm):
        
        # Changing field 'Proposal.owner'
        db.alter_column('proposal_proposal', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
