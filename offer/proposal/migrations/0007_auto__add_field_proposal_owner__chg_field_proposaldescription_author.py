...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('proposal_proposal', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wlasciciel', null=True, to=orm['auth.User']), keep_default=False)

        # Changing field 'ProposalDescription.author'
        db.alter_column('proposal_proposaldescription', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProposalDescription.author'
        db.alter_column('proposal_proposaldescription', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'proposal.proposal': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wlasciciel'", 'null': 'True', 'to': "orm['auth.User']"}),
