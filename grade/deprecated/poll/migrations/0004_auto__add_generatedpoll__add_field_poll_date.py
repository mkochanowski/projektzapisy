...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GeneratedPoll'
        db.create_table('poll_generatedpoll', (
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('users_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Type'], null=True, blank=True)),
        ...
        db.send_create_signal('poll', ['GeneratedPoll'])

        # Adding field 'Poll.date'
        db.add_column('poll_poll', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=0, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'GeneratedPoll'
        db.delete_table('poll_generatedpoll')

        # Deleting field 'Poll.date'
        db.delete_column('poll_poll', 'date')
    ...
    models = {
        ...
        'poll.generatedpoll': {
            'Meta': {'object_name': 'GeneratedPoll'},
            ...
            'users_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.Type']", 'null': 'True', 'blank': 'True'})
        },
        'poll.option': {
