...
urlpatterns = patterns('',
    ...
    url(r'ajax_keys_progress$', 'fereol.grade.ticket_create.views.ajax_keys_progress', name='grade-ticket-keys-progress'),
    url(r'ajax_keys_generate$', 'fereol.grade.ticket_create.views.ajax_keys_generate', name='grade-ticket-keys-generator'),
