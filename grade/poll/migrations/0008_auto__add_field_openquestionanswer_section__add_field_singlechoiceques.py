...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenQuestionAnswer.section'
        db.add_column('poll_openquestionanswer', 'section', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.Section']), keep_default=False)

        # Adding field 'SingleChoiceQuestionAnswer.section'
        db.add_column('poll_singlechoicequestionanswer', 'section', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.Section']), keep_default=False)

        # Adding field 'MultipleChoiceQuestionAnswer.section'
        db.add_column('poll_multiplechoicequestionanswer', 'section', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.Section']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'OpenQuestionAnswer.section'
        db.delete_column('poll_openquestionanswer', 'section_id')

        # Deleting field 'SingleChoiceQuestionAnswer.section'
        db.delete_column('poll_singlechoicequestionanswer', 'section_id')

        # Deleting field 'MultipleChoiceQuestionAnswer.section'
        db.delete_column('poll_multiplechoicequestionanswer', 'section_id')
