...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenQuestionAnswer.saved_ticket'
        db.add_column('poll_openquestionanswer', 'saved_ticket', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.SavedTicket']), keep_default=False)

        # Removing M2M table for field saved_ticket on 'OpenQuestionAnswer'
        db.delete_table('poll_openquestionanswer_saved_ticket')

        # Adding field 'SingleChoiceQuestionAnswer.saved_ticket'
        db.add_column('poll_singlechoicequestionanswer', 'saved_ticket', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.SavedTicket']), keep_default=False)
        ...
        # Adding field 'MultipleChoiceQuestionAnswer.saved_ticket'
        db.add_column('poll_multiplechoicequestionanswer', 'saved_ticket', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['poll.SavedTicket']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'OpenQuestionAnswer.saved_ticket'
        db.delete_column('poll_openquestionanswer', 'saved_ticket_id')
        ...
        # Deleting field 'SingleChoiceQuestionAnswer.saved_ticket'
        db.delete_column('poll_singlechoicequestionanswer', 'saved_ticket_id')
        ...
        # Deleting field 'MultipleChoiceQuestionAnswer.saved_ticket'
        db.delete_column('poll_multiplechoicequestionanswer', 'saved_ticket_id')
