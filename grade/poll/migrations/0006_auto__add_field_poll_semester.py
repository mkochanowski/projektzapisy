...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Poll.semester'
        db.add_column('poll_poll', 'semester', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['subjects.Semester']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Poll.semester'
        db.delete_column('poll_poll', 'semester_id')
