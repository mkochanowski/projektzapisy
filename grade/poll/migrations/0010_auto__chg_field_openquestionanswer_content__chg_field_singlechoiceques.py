...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OpenQuestionAnswer.content'
        db.alter_column('poll_openquestionanswer', 'content', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'SingleChoiceQuestionAnswer.option'
        db.alter_column('poll_singlechoicequestionanswer', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poll.Option'], null=True, blank=True))

        # Changing field 'MultipleChoiceQuestionAnswer.other'
        db.alter_column('poll_multiplechoicequestionanswer', 'other', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'OpenQuestionAnswer.content'
        db.alter_column('poll_openquestionanswer', 'content', self.gf('django.db.models.fields.TextField')())

        # Changing field 'SingleChoiceQuestionAnswer.option'
        db.alter_column('poll_singlechoicequestionanswer', 'option_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['poll.Option']))

        # Changing field 'MultipleChoiceQuestionAnswer.other'
        db.alter_column('poll_multiplechoicequestionanswer', 'other', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
