...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SingleChoiceQuestion.description'
        db.add_column('poll_singlechoicequestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'OpenQuestion.description'
        db.add_column('poll_openquestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)

        # Adding field 'MultipleChoiceQuestion.description'
        db.add_column('poll_multiplechoicequestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SingleChoiceQuestion.description'
        db.delete_column('poll_singlechoicequestion', 'description')

        # Deleting field 'OpenQuestion.description'
        db.delete_column('poll_openquestion', 'description')

        # Deleting field 'MultipleChoiceQuestion.description'
        db.delete_column('poll_multiplechoicequestion', 'description')
