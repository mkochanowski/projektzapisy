...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SingleChoiceQuestion.description'
        db.alter_column('poll_singlechoicequestion', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'OpenQuestion.description'
        db.alter_column('poll_openquestion', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'MultipleChoiceQuestion.description'
        db.alter_column('poll_multiplechoicequestion', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SingleChoiceQuestion.description'
        db.alter_column('poll_singlechoicequestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True))

        # Changing field 'OpenQuestion.description'
        db.alter_column('poll_openquestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True))

        # Changing field 'MultipleChoiceQuestion.description'
        db.alter_column('poll_multiplechoicequestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True))
    ...
    models = {
        ...
        'poll.poll': {
            ...
            'sharing_employees': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['users.Employee']", 'null': 'True', 'blank': 'True'}),
