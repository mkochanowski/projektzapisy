...
urlpatterns = patterns('',
    ...
    url(r'managment/show_poll/(?P<poll_id>[1-9][0-9]*)/$', 'fereol.grade.poll.views.show_section', name='grade-poll-show_poll'),
    url(r'managment/delete_polls$', 'fereol.grade.poll.views.delete_section', name='grade-poll-delete_poll'),
