...
urlpatterns = patterns('',
    ...
    url(r'^enrollment/$', 'apps.mobile.views.studentSubjectList', name = 'student-enrollment'),
    url(r'^enrollment/other/', 'apps.mobile.views.otherSubjects', name = 'enrollment-other'),
    #STUDENT-SCHEDULE
    ...
    url(r'^subject/(?P<slug>[\w\-_]+)', 'apps.mobile.views.subjectTerms', name='subject-terms'),
