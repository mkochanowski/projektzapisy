...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.receive_mass_mail_offer'
        db.add_column('users_student', 'receive_mass_mail_offer', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Student.receive_mass_mail_offer'
        db.delete_column('users_student', 'receive_mass_mail_offer')
