...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_type', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=45))
    
    
    def backwards(self, orm):
        
        # Changing field 'Type.name'
        db.alter_column('users_type', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
