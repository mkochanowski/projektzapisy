...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.records_opening_hour'
        db.alter_column('users_student', 'records_opening_hour', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Student.records_opening_hour'
        db.alter_column('users_student', 'records_opening_hour', self.gf('django.db.models.fields.DateTimeField')())
